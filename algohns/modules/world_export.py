...
from .world_events import EVENT_CATALOGUE, expected_event_market_drift
from .world_forward import ForwardConfig, WorldTimeline, build_world, simulate_world
from .world_universe import COMPANIES, COUNTRIES
...
def export_static_world() -> dict:
    ...
    """
    from .world_events import CHOKEPOINTS, EVENT_CATALOGUE
    from .world_forward import SECTOR_PROFILE, ForwardConfig
    from .world_universe import SUPPLY_LINKS
