...
from .world_universe import COMPANIES, COUNTRIES, SUPPLY_LINKS

__all__ = ["ForwardConfig", "WorldTimeline", "build_world", "simulate_world"]
...
def build_world() -> SupplyChainGraph:
    ...
    Lives here rather than in its own module so the dependency chain stays
    flat: world_universe -> contagion -> world_forward -> world_export.
    """
    nodes = [
        CompanyNode(
            ticker=c.ticker,
